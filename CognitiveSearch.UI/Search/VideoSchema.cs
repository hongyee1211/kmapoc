...
{
    public enum PreferredVideoFilter { None, MinValue, MaxValue, RangeMin, RangeMax, Range };

    [Serializable]
    public class VideoSearchField
    {
    ...
    {
        public static SearchField ToVideoSearchField(this Field field)
        {
            Type type;
        ...
        public static VideoSchema AddVideoFields(this VideoSchema schema, IEnumerable<Field> fields)
        {
