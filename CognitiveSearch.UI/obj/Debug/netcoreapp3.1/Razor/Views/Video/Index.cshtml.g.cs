#pragma checksum "C:\Ashley\Code\kmapoc\CognitiveSearch.UI\Views\Video\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "88c4c5fd502afbf8adea37fc823888ddae97297e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"88c4c5fd502afbf8adea37fc823888ddae97297e", @"/Views/Video/Index.cshtml")]
            ...
            WriteLiteral(@"       $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.results.length > 0) {
                                   ...
                                   ");
            WriteLiteral(@"     pivotsHTML += '<div id=""viName"" class=""viName"">';
                                        pivotsHTML += '<button id=""idMyModal"" type=""button"" class=""btn btn-info btn-lg"" data-toggle=""modal"" data-target=""#myModal"" style=""background-color: transparent; border: none;""><h4>' + data.results[i].name + '</h4></button>';
                                        pivotsHTML += '</div>';
                                        ...
                                        if (data.results[i].searchMatches.length > 0) {
                                            ...
                                            for (var j = 0; j < data.results[i].searchMatches.length; j++) {
                                                ...
                                                var videoText = dat");
            WriteLiteral(@"a.results[i].searchMatches[j].text.replace(data.results[i].searchMatches[j].exactText, ""<b>"" + data.results[i].searchMatches[j].exactText + '</b>');
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "88c4c5fd502afbf8adea37fc823888ddae97297e8706", async() => {
            }
            );
        ...
        <div class=""modal fade"" id=""myModal"" role=""dialog"">
            ...
            WriteLiteral(@"ta-dismiss=""modal""><i class=""ms-Icon ms-Icon--Clear""></i></span>
                            ...
                            <div style=""margin-top: 40px; margin-left: 6px; margin-right: 6px;"">
                                <iframe width=""852"" height=""480"" src=""https://www.videoindexer.ai/embed/player/00000000-0000-0000-0000-000000000000/d9d4860279/?&locale=en&location=Trial"" frameborder=""0"" allowfullscreen></iframe>
                                <iframe width=""580"" height=""600"" src=""https://www.videoindexer.ai/embed/insights/00000000-0000-0000-0000-000000000000/d9d4860279/?&locale=en&location=Trial"" frameborder=""0"" allowfullscreen></iframe>
