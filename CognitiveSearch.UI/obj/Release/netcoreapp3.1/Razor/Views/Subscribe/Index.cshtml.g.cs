#pragma checksum "C:\Ashley\Code\kmapoc\CognitiveSearch.UI\Views\Subscribe\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d283d17a64613a84c64af4bcba1d16d13b007cfe"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d283d17a64613a84c64af4bcba1d16d13b007cfe", @"/Views/Subscribe/Index.cshtml")]
...
#nullable disable
    ...
    function updateTable(query = null) {
        ...
        for (i in subscriptions) {
            ...
            //    ratingContent = `<td class=""ratings");
            WriteLiteral(@"-table-column-align ratings-table-thumbs-up""></td>`
            //}
            //else {
            ...
            rowsHtml += `<tr class=""ratings-table-rows"">
                                ...
                                <td class=""ratings-table-column-align ratings-table-delete"" onclick=""remove('${subscription.query}');""><span class=""fa fa-trash""></span></td>
                            </tr>`
        }
        table.html(rowsHtml);
    }
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d283d17a64613a84c64af4bcba1d16d13b007cfe7108", async() => {
            }
            );
