...
function GetTranscriptHTML(result) {
    ...
    if (!!result.translated_text && result.translated_text !== null && result.language !== "en" ) {
        transcriptContainerHTML = '<div style="overflow-x:auto;"><table class="table table-bordered"><thead><tr><th>Original Content</th><th>Translated (En)</th></tr></thead>';
        ...
        transcriptContainerHTML = '<div style="overflow-x:auto;"><table class="table table-bordered"><thead><tr><th>Original Content</th></tr></thead>';
        transcriptContainerHTML += '<tbody>';
...
function GetMetadataHTML(result) {
    ...
    metadataContainerHTML += '<h4 style="color: #fff;">Indexed Metadata</h4><div style="overflow-x:auto;"><table class="table metadata-table table-bordered"><thead><tr><th data-field="key" class="key">Key</th><th data-field="value">Value</th></tr></thead>';
